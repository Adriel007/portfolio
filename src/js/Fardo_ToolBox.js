...
class Fardo_ToolBox {
    ...
    removeTypingEffect(blinkInterval) {
    ...
    performanceCodeTest(functionsInArray = [], returnAverage = false) {
        let length = functionsInArray.length;
        let performances = [];
        let averages = [];
        ...
        for (let c = 0; c < length; c++) {
            ...
            if (returnAverage == true) {
                ...
                averages.push((t3 - t2) / length + "ms");
            }
        }

        return { performance: performances, average: averages };
    }
};
